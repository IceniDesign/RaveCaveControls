...
if IceniDebug == True:
    OMX5 = subprocess.Popen(['omxplayer', '--loop', '--win', WinSize, '--layer', str(Layer), movie5],stdin=subprocess.PIPE,encoding='utf8') #Load the 1st video
else:
    OMX5 = subprocess.Popen(['omxplayer', '--loop', '--layer', str(Layer), movie5],stdin=subprocess.PIPE,encoding='utf8') #Load the 1st video
    ...
    while True:
        ...
        if button1 == False: #If button1 is pressed...
            if OMX1_active == False: #And movie1 is not already running
                ...
                if IceniDebug == True:
                    OMX1 = subprocess.Popen(['omxplayer', '--loop', '--win', WinSize, '--layer', str(Layer), movie1],stdin=subprocess.PIPE,encoding='utf8') #Load the 1st video
                else:
                    OMX1 = subprocess.Popen(['omxplayer', '--loop', '--layer', str(Layer), movie1],stdin=subprocess.PIPE,encoding='utf8') #Load the 1st video
                time.sleep(5)
            ...
            if OMX2_active == False: #And movie1 is not already running
                ...
                if IceniDebug == True:
                    OMX2 = subprocess.Popen(['omxplayer', '--loop', '--win', WinSize, '--layer', str(Layer), movie2],stdin=subprocess.PIPE,encoding='utf8') #Load the 1st video
                else:
                    OMX2 = subprocess.Popen(['omxplayer', '--loop', '--layer', str(Layer), movie2],stdin=subprocess.PIPE,encoding='utf8') #Load the 1st video
                time.sleep(5)
            ...
            if OMX3_active == False: #And movie1 is not already running
                ...
                if IceniDebug == True:
                    OMX3 = subprocess.Popen(['omxplayer', '--loop', '--win', WinSize, '--layer', str(Layer), movie3],stdin=subprocess.PIPE,encoding='utf8') #Load the 1st video
                else:
                    OMX3 = subprocess.Popen(['omxplayer', '--loop', '--layer', str(Layer), movie3],stdin=subprocess.PIPE,encoding='utf8') #Load the 1st video
                time.sleep(5)
                if OMX1_active == True: #shutdown movie1 if it is playing
                    OMX1.stdin.write('q')
                    OMX1.stdin.flush()
            ...
            if OMX4_active == False: #And movie1 is not already running
                ...
                if IceniDebug == True:
                    OMX4 = subprocess.Popen(['omxplayer', '--loop', '--win', WinSize, '--layer', str(Layer), movie4],stdin=subprocess.PIPE,encoding='utf8') #Load the 1st video
                else:
                    OMX4 = subprocess.Popen(['omxplayer', '--loop', '--layer', str(Layer), movie4],stdin=subprocess.PIPE,encoding='utf8') #Load the 1st video
                time.sleep(5)
                if OMX1_active == True: #shutdown movie1 if it is playing
                    OMX1.stdin.write('q')
                    OMX1.stdin.flush()
