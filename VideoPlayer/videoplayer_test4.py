# I've seperated them out into different areas of the screen for troubleshooting and this is working!!
...
Space = subprocess.Popen(['omxplayer', '--win', '100,100,400,400', '--layer', '1', movie2],stdin=subprocess.PIPE) #Load the 1st video
...
while True:
    ...
    if input_state1 == False:
        #Play video 1
        Clouds = subprocess.Popen(['omxplayer', '--win', '100,100,400,400', '--layer', '2', movie1],stdin=subprocess.PIPE) #Load the 1st video
        time.sleep(5)
        Space.stdin.write('q')
        Space.stdin.flush()
    ...
    #If GPIO(18) is shorted to ground
        ...
        #Play video 1
        Space = subprocess.Popen(['omxplayer', '--win', '600,100,900,400', '--layer', '3', movie2],stdin=subprocess.PIPE) #Load the 1st video
        time.sleep(5)
